...
export default function SurveyForm({
  ...
  const handleNext = () => {
    const currentQuestionText = currentQuestion.question.toString();
    if (
      currentQuestionText.includes(
        "Consent: I have read the introductory information about this survey and consent to freely respond to the questionnaire."
      ) &&
      responses[currentQuestion._id] === "No"
    ) {
    ...
    try {
      ...
      const formattedResponses = Object.entries(responses)
        .map(([questionId, answer]) => {
          ...
          if (Array.isArray(answer)) {
            console.log("for multiple choice", questionId, question, answer);
            // Multi-choice question
            return {
              questionId,
              question: question?.question,
              ...
              <>
                ...
                {showConsentModal && (
                  <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="bg-white p-6 rounded-lg shadow-lg w-[80%] max-w-md relative">
                      <h2 className="text-xl font-bold mb-4">Thank You</h2>
                      <p>
                        You have chosen not to consent to the survey. You cannot
