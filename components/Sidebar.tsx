...
// import {
//   fetchTotalStates,
//   fetchAllSurveyResponsesByAdmin,
// } from "@/services/apiService"; // Import the updated service
// import { useRouter } from "next/navigation";
// import { SurveyResponse } from "@/services/apiService";

// interface SidebarProps {
//   setFilteredData: Dispatch<SetStateAction<SurveyResponse[]>>;
// }

// const Sidebar: React.FC<SidebarProps> = ({ setFilteredData }) => {
//   const [isOpen, setIsOpen] = useState(false);
//   const [isDropdownOpen, setIsDropdownOpen] = useState(false);
//   const [states, setStates] = useState<string[]>([]);
//   const router = useRouter(); // Move router hook here
...
//     try {
//       const data = await fetchAllSurveyResponsesByAdmin(state);
